...
let discriptionPlace = document.getElementById("discription");
...
showPtn.forEach((element) => {
    ...
    element.addEventListener('click', () => {
        ...
        // all Description
        let discription = productDiv.querySelector("#allDescription").innerHTML;
        discriptionPlace.innerHTML = discription;
